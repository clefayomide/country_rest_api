            ...
            <div className='flex flex-wrap justify-between items-center mt-12'>
                ...
                <div className='w-5/9'>
                    ...
                    <div className='flex justify-between pt-5'>
                        ...
                        <div>
                            <p className='-ml-80 pt-2 pb-2 dark:text-darkModeTextAndDarkModeElements font-semibold'>Top Level Domain: <span className='dark:text-slate-200 font-normal'>{tld}</span></p >
                            <p className='-ml-80 pt-2 pb-2 dark:text-darkModeTextAndDarkModeElements font-semibold'>Currencies: <span className='dark:text-slate-200 font-normal'>{hasCurrency()}</span></p >
                            <p className='-ml-80 pt-2 pb-2 dark:text-darkModeTextAndDarkModeElements font-semibold'>{hasLanguage().length > 1 ? "Languages" : "Language"}: {hasLanguage().map((lang) => <span key={uuidv4()} className='dark:text-slate-200 font-normal'>{lang}, </span>)}</p>
                        </div>
                    </div>
